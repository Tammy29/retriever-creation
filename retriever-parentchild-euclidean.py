...
from src.APIEmbeddings import APIEmbeddings
...
def create_multi_vector_retriever(folder_path, retriever_name):
    ...
    vectorstore = FAISS.from_documents(documents=all_child_docs,embedding=embedding)
    ...
    API_URL_2 = 'http://localhost:8000/v1/embed'
    retriever.vectorstore.embedding=get_embedding_model(API_URL_2)
...
#create retrievers
create_multi_vector_retriever(policies_path+'gl', "gl_bge_retriever-parentchild-euclidean")
create_multi_vector_retriever(policies_path+'finance',"finance_bge_retriever-parentchild-euclidean")
create_multi_vector_retriever(policies_path+'procurement',"procurement_bge_retriever-parentchild-euclidean")
create_multi_vector_retriever(policies_path+'it',"it_bge_retriever-parentchild-euclidean")